...
NGame = {
	START_DATE = "1999.1.1",
	END_DATE = "2500.1.1",
	MAX_RANDOM_NEW_WORLD = "1999.1.2",

	GREAT_POWER_FRENZY_START = "2100.1.1",	-- Latest date for the start of the Great Power Frenzy (struggle).
...
NDiplomacy = {
	...
	BREAK_ALLIANCE_DISTANCE_FACTOR = -0.015,			-- AI acceptance factor depending on distance.
...
NCountry = {
	...
	MIN_TECH_FOR_CIRCUMNAVIGATE = 35,			-- Must have this level of dip tech to circumnavigate the globe
...
--	CIRCUMNAVIGATION_PROVINCE_7 = 3387,		    -- Port of Lost Souls
	...
	POWER_MAX = 1999,								-- how much power can be stored at maximum.
...
NMilitary = {
	...
	GALLEY_BONUS_INLAND_SEA = 0.0,
	GALLEY_BONUS_COASTAL_SEA = 0.0,
	...
	NAVAL_SUPPLY_RANGE = 500, 						-- Supply range for ships.
	...
	NOMAD_LOOT_TRADITION = 0.03,	 				-- _MDEF_NOMAD_LOOT_TRADITION_;Military tradition a horde gets from looting territory
	...
	STRAIT_CROSSING_PENALTY = 1,						-- Dice roll penalty from strait crossing
	SEA_LANDING_PENALTY = 1,							-- Dice roll penalty from sea invasion
...
NAI = {
	...
	DIPLOMATIC_INTEREST_DISTANCE = 500, -- If border distance is greater than this, diplomatic AI will have less interest in the country
	CONQUEST_INTEREST_DISTANCE = 500, -- Beyond this range, AI is less interested in conquest of provinces
